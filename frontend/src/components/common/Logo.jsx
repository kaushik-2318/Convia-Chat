...
export const Logo = ({ className = '' }) => {
  return (
    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id="convia-gradient" x1="0" y1="0" x2="100" y2="100" gradientUnits="userSpaceOnUse">
      ...
      <path d="M70 30C60 20 40 20 30 30C15 45 15 70 30 80C45 90 65 85 75 70" stroke="url(#convia-gradient)" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" filter="url(#glow)" />
