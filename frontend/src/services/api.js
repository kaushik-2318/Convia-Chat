...
export const { useCheckEmailMutation, useRegisterMutation, useLoginMutation, useSendOtpMutation, useVerifyOTPMutation, useResendOtpMutation, useForgotPasswordMutation, useResetPasswordMutation } =
  api;
